...
describe('BIDS example datasets with gitTreeMode', function() {
  // validate.BIDS options with gitTreeMode on
  const options = { ignoreNiftiHeaders: true, json: true, gitTreeMode: true }
  const enableNiftiHeaders = { json: true, gitTreeMode: true }
